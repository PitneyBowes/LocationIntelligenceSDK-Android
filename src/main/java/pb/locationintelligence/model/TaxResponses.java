...
public class TaxResponses   {
  ...
  private List<TaxResponse> taxResponses = new ArrayList<TaxResponse>();

  public TaxResponses taxResponses(List<TaxResponse> taxResponses) {
  ...
  **/
  ...
  public List<TaxResponse> getTaxResponses() {
    return taxResponses;
  }

  public void setTaxResponses(List<TaxResponse> taxResponses) {
    this.taxResponses = taxResponses;
  }
