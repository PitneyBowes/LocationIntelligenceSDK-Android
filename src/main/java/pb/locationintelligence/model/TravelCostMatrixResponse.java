...
import pb.locationintelligence.model.TravelCostMatrixResponseMatrix;
...
public class TravelCostMatrixResponse   {
  ...
  private List<TravelCostMatrixResponseMatrix> matrix = new ArrayList<TravelCostMatrixResponseMatrix>();

  public TravelCostMatrixResponse matrix(List<TravelCostMatrixResponseMatrix> matrix) {
    this.matrix = matrix;
    return this;
  }
  ...
  **/
  ...
  public List<TravelCostMatrixResponseMatrix> getMatrix() {
    return matrix;
  }

  public void setMatrix(List<TravelCostMatrixResponseMatrix> matrix) {
    this.matrix = matrix;
  }
